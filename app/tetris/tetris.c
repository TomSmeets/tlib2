...
static void tetris_draw(Tetris *tetris) {
    ...
    for (u32 i = 0; i < sx*sy; ++i) {
        ...
        switch(color) {
            case 0: *px++ = 0xff000000; break;
            case 1: *px++ = 0xff0000ff; break;
            case 2: *px++ = 0xff00ff00; break;
            case 3: *px++ = 0xffff0000; break;
            case 4: *px++ = 0xffffff00; break;
            case 5: *px++ = 0xffff00ff; break;
            case 6: *px++ = 0xff00ffff; break;
            default: *px++ = 0xffffffff; break;
        }
    }
